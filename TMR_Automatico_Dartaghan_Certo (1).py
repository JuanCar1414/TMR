...
def Dartaghan (notaDoAluno,presençaDoAluno_Tratada,rendimentoFinal_Tratado,notaDeComportamento):
    ...
    if (votoDartaghan == 9):
        ...
        diferençaDartaghan1 = abs((Dartaghan1(notaDoAluno,presençaDoAluno_Tratada,rendimentoFinal_Tratado,notaDeComportamento) \n - Dartaghan2(notaDoAluno,presençaDoAluno_Tratada,rendimentoFinal_Tratado,notaDeComportamento)))
